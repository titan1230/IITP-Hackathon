  ...
  return (
    <div className="h-30 w-full flex bg-transparent  justify-around items-center font-Helveltica">
      <div className=" mx-4 my-2 flex place-content-around justify-center items-center space-x-16">
        ...
        <div className="w-[1030px] h-[60px] bg-white/30 text-black opacity-100 rounded-full backdrop-filter backdrop-blur-sm font-semibold text-xl flex items-center justify-around font-createRound">
          <span>Home</span>
          <span>Care</span>
          <span>Health</span>
          ...
          <div className="flex space-x-3">
            ...
            <div className="bg-white opacity-100 z-10 rounded-[500px] h-[44px]">
              <input type="text" placeholder="Search" className="font-createRound outline-none border-none text-black font-semibold bg-white px-4 py-2 rounded-lg" />
            </div>
            ...
            <div className="h-[44px] w-[44px] bg-white opacity-100 rounded-full backdrop-filter backdrop-blur-md flex items-center justify-around">
              <Image src={SearchBtn} className="h-[45px] w-[45px] cursor-pointer" alt='Search logo'/>
            </div>
          </div>
